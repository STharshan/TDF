      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <div className="flex space-x-4">
            <a href="https://web.facebook.com/p/TDF-TheLab-61555629075147/?_rdc=1&_rdr#" className="text-primary-hover transition">
              <FaFacebookF />
            </a>
            <a href="https://www.instagram.com/explore/locations/202686376268678/tdf-sports-and-performance-gym/" className="text-primary-hover transition">
              <FaInstagram />
            </a>
          </div>
        </div>
