      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 mt-15">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div data-aos="fade-right">
            ...
            >
              At TDF TheLab Sports & Performance Gym, We believe in elevating more than just weights, we're here to inspire a lifestyle of strength, health, and overall well- being.
            </p>
